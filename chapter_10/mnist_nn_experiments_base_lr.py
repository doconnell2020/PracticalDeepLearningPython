...
def main():
    ...
    for lr in base_lr:
        ...
        print(
            "base_lr = %0.5f, score = %0.5f, loss = %0.5f, epochs = %d" % (lr, s, l, 50)
        )
    print()
    ...
    for i in range(len(base_lr)):
        ...
        print(
            "base_lr = %0.5f, score = %0.5f, loss = %0.5f, epochs = %d, time = %0.3f"
            % (base_lr[i], s, l, epochs[i], e)
        )
    print()
