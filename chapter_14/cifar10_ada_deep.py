#
#  file:  cifar10_ada_deep.py
#
#  Adadelta optimizer, deep network on cifar10 dataset
#
...
df.to_csv(r"../data/cifar10/cifar10_ada_deep_model.csv", index=False, header=True)

model.save("../data/cifar10/cifar10_ada_deep_model.h5")
