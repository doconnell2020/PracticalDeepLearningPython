#
#  file:  cifar10_sgd_deep.py
#
#  Stochastic gradient Descent optimizer, deep network on cifar10 dataset
#
...
df.to_csv(r"../data/cifar10/cifar10_sgd_deep_model.csv", index=False, header=True)

model.save("../data/cifar10/cifar10_sgd_deep_model.h5")
