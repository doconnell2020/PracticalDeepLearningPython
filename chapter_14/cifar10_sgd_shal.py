#
#  file:  cifar10_sgd_shal.py
#
#  Stochastic gradient Descent optimizer, shallow network on cifar10 dataset
#
...
df.to_csv(r"../data/cifar10/cifar10_sgd_shal_model.csv", index=False, header=True)

model.save("../data/cifar10/cifar10_sgd_shal_model.h5")
