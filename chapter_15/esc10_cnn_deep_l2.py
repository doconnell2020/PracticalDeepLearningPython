...
model.add(
    Conv2D(64, (3, 3), activation="relu", kernel_regularizer=keras.regularizers.l2(l))
)
...
model.add(Flatten())
model.add(Dense(128, activation="relu", kernel_regularizer=keras.regularizers.l2(l)))
