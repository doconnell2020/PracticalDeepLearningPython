...
def augment_audio(src_list, typ):
    ...
    for i, s in enumerate(src_list):
        ...
        base = os.path.abspath(
            "../data/audio/ESC-10/augmented/%s/%s" % (typ, os.path.basename(f)[:-4])
        )
        fname = base + ".wav"
...
def main():
    ...
    os.system(
        "rm -rf ../data/audio/ESC-10/augmented; mkdir ../data/audio/ESC-10/augmented"
    )
    os.system(
        "mkdir ../data/audio/ESC-10/augmented/train ../data/audio/ESC-10/augmented/test"
    )
