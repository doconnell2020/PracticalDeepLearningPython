#
#  file:  esc10_audio_cnn_shallow.py
#
#  1D convolutional network, shallow
#
#  RTK, 13-Nov-2019
...
model = Sequential()
model.add(Conv1D(32, kernel_size=z, activation="relu", input_shape=nsamp))
...
model.save("esc10_audio_cnn_shallow_%s_model.h5" % kstr)
